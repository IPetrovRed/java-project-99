...
public class Labels {
    ...
    private LabelDTO create(@RequestBody LabelCreate labelCreateDTO) {
        return labelService.create(labelCreateDTO);
    }

    @PutMapping("/{id}")
    private LabelDTO updateById(@PathVariable Long id, @Valid @RequestBody LabelUpdate labelUpdateDTO) {
